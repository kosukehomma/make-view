...
const accountItem = (account, action)=>{
    return (0, _createElementDefault.default)("div", {
        attrs: {},
        children: [
            (0, _createElementDefault.default)("div", {
                attrs: {
                ...
                children: [
                    (0, _createElementDefault.default)("div", {
                        attrs: {},
                        children: [
                            (0, _createElementDefault.default)("p", {
                                attrs: {
                                    class: "account__name"
                                },
                                children: [
                    ...
                    (0, _createElementDefault.default)("div", {
                        attrs: {},
                        children: [
                            (0, _createElementDefault.default)("button", {
                                attrs: {
                                    type: "button",
...
const view = (props, action)=>(0, _createElementDefault.default)("ul", {
        attrs: {
            class: "accountList"
        },
        children: props.accounts.map((e)=>{
            return (0, _createElementDefault.default)("li", {
                attrs: {
...
},{"./vdom/createElement":"1MvFP","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./vdom/app":"eoqKr"}],"1MvFP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"eoqKr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./patch":"l8Wc3"}],"l8Wc3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const updateAttrs = (target, oldAttrs, newAttrs)=>{
    for(const attr in oldAttrs)if (!(0, _utils.isEventAttr)(attr)) target.removeAttribute(attr);
    for(const attr1 in newAttrs)if (!(0, _utils.isEventAttr)(attr1)) target.setAttribute(attr1, newAttrs[attr1]);
};
const patch = (parent, newNode, oldNode, index = 0)=>{
    if (!oldNode) parent.appendChild((0, _render.render)(newNode));
...
},{"./render":"1HyMl","./utils":"4yfBI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1HyMl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render);
var _utils = require("./utils");
const setAttrs = (target, attrs)=>{
    for(const attr in attrs)if ((0, _utils.isEventAttr)(attr)) target.addEventListener(attr.slice(2), attrs[attr]);
    else target.setAttribute(attr, attrs[attr]);
};
function renderElement({ tagName , attrs , children  }) {
    const $el = document.createElement(tagName);
    setAttrs($el, attrs);
    for(const child in children)$el.appendChild(render(children[child]));
    return $el;
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["cVgJb","ebWYT"], "ebWYT", "parcelRequired88a")
